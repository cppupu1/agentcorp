...
5. 对时间敏感信息（如发布计划、政策、价格、财务）要求使用绝对日期（YYYY-MM-DD）并标注可核验来源链接
6. 关键结论必须至少有2个独立来源交叉验证，且优先使用一手来源（官方公告/官方博客/监管文件/论文/财报）`,
      },
      {
        name: '研究员',
...
5. 来源优先级：官方/论文/监管/财报 > 主流媒体 > 自媒体/转载；不得用单一自媒体支撑关键结论
6. 输出中必须附可点击来源链接，并给出具体日期（YYYY-MM-DD）；不确定信息要明确标注“待核验”`,
      },
      {
        name: '撰稿人',
...
5. 结论段必须保留来源编号或链接，不得删除关键证据链
6. 对“最新/近期/本周/今年”等表述必须替换为具体日期区间，避免时间歧义`,
      },
    ],
  },
  {
